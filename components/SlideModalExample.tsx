...
// import { Button, SlideModal, SlideModalProps } from 'beeshell-ls'
...
//         <Button style={{ marginTop: 12 }} size='sm' onPress={() => this.slideModal.open()}>
//           基础
//         </Button>
...
//           cancelable={true}
//         >
//           {this.renderModalContent({ direction: 'down', align: 'center' })}
//         </SlideModal>

//         <Button style={{ marginTop: 12 }} size='sm' onPress={() => this.slideModalX.open()}>
//           自定义样式
//         </Button>
//         <SlideModal<SlideModalProps>
...
//         <Button style={{ marginTop: 12 }} size='sm' onPress={() => {
//           try {
